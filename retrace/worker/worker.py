...
if __name__ == "__main__":
    ...
    try:
        ...
        mockcfg.write("baseurl=http://localhost:10080/" + distribution + "-" + version + "-" + arch + "/\n")
        mockcfg.write("failovermethod=priority\n")
        mockcfg.write("\n")
        mockcfg.write("[fedora-debuginfo]\n")
        mockcfg.write("name=fedora-debuginfo\n")
        mockcfg.write("baseurl=http://localhost:10080/" + distribution + "-" + version + "-" + arch + "-debuginfo/\n")
        mockcfg.write("failovermethod=priority\n")
        mockcfg.write("\n")
        mockcfg.write("[updates]\n")
        mockcfg.write("name=updates\n")
        mockcfg.write("baseurl=http://localhost:10080/" + distribution + "-" + version + "-" + arch + "-updates/\n")
        mockcfg.write("failovermethod=priority\n")
        mockcfg.write("\n")
        mockcfg.write("[updates-debuginfo]\n")
        mockcfg.write("name=updates-debuginfo\n")
        mockcfg.write("baseurl=http://localhost:10080/" + distribution + "-" + version + "-" + arch + "-updates-debuginfo/\n")
        mockcfg.write("failovermethod=priority\n")
        mockcfg.write("\n")
        mockcfg.write("[updates-testing]\n")
        mockcfg.write("name=updates-testing\n")
        mockcfg.write("baseurl=http://localhost:10080/" + distribution + "-" + version + "-" + arch + "-updates-testing/\n")
        mockcfg.write("failovermethod=priority\n")
        mockcfg.write("\n")
        mockcfg.write("[updates-testing-debuginfo]\n")
        mockcfg.write("name=updates-testing-debuginfo\n")
        mockcfg.write("baseurl=http://localhost:10080/" + distribution + "-" + version + "-" + arch + "-updates-testing-debuginfo/\n")
        mockcfg.write("failovermethod=priority\n")
        mockcfg.write("\n")
