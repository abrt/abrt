...
#        export REPORT_CLIENT_NONINTERACTIVE
    ...
    rlPhaseStartTest "rhtsupport create with option -u"
        ...
        rlAssertGrep "curl sent header: 'POST /rs/cases/[0-9]*/attachments/.*/(comments|attachments) HTTP/1" client_create3 -E
   ...
   rlPhaseStartTest "rhtsupport create with option -u with attach email"
        ...
        rlAssertGrep "curl sent header: 'POST /rs/cases/[0-9]*/attachments/.*/(comments|attachments) HTTP/1" client_create4 -E
    ...
    rlPhaseStartTest "rhtsupport create with option -u (uReport has been already submitted, email is configured)"
        ...
        rlAssertGrep "curl sent header: 'POST /rs/cases/[0-9]*/attachments/.*/(comments|attachments) HTTP/1" client_create5 -E
    ...
    rlPhaseStartTest "rhtsupport create with option -u (uReport has been already submitted, email is not configured)"
        ...
        rlAssertGrep "curl sent header: 'POST /rs/cases/[0-9]*/attachments/.*/(comments|attachments) HTTP/1" client_create6 -E
