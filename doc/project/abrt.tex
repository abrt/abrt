...
\umlclass[x=-6,y=6]{report selinux state}{
...
\texttt{context} & ASCII string, max. 128 characters & yes, if the \texttt{state} is either \texttt{enforcing} or \texttt{permissive} & \texttt{ps -e --context} \\
